...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/shiny-wildflower-61dd#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/shiny-wildflower-61dd
```

A live public deployment of this template is available at [https://shiny-wildflower-61dd.templates.workers.dev](https://shiny-wildflower-61dd.templates.workers.dev)
